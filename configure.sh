...
sudo scutil --set ComputerName "inote"
sudo scutil --set HostName "inote"
sudo scutil --set LocalHostName "inote"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "inote"
